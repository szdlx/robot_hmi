...
public:
    ...
    QWidget* getFlowWidget()    {return this->flowPanel;}
    QButtonGroup* getButtonGroup() {return this->flowButton;}
    QComboBox* getEnCodeBox()   {return this->enbox;}
...
private slots:
    ...
    //处理按钮单击
    void btnClicked();
    void comboxCurrentChange(int index);
...
signals:
    ...
    void comboxCurrentChange(const int index,const QString &objName);
